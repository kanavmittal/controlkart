// Backported regression coverage from medusajs/medusa commit 18474de124868370298addf195e5229ca6792f81 (MIT).
import {
  Collection,
  Entity,
  ManyToOne,
...
import { defineConfig } from "@medusajs/framework/mikro-orm/postgresql"
import { pruneFindOptionsAgainstMetadata } from "@medusajs/framework/utils"
